...
export const notificationService = {
  getUserNotifications: (username) => notificationAPI.getUserNotifications(username),
  getUnreadCount: (username) => notificationAPI.getUnreadCount(username),
  markAsRead: (notificationId) => notificationAPI.markAsRead(notificationId),
  markAllAsRead: (username) => notificationAPI.markAllAsRead(username),
